...
:::caution Did you use IPI method?

Skip this step if you have created OCP cluster using ``IPI install`` method from this documentation site.

Move on to testing PVC section. 

:::

```mdx-code-block
<details>
<summary>Instructions to create MachineConfig to enable iSCSI Daemons</summary>
<div>
<body>
```
