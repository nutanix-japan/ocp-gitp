...
1.  Download blueprint1 by right-clicking on this link [Provisioning VM](https://raw.githubusercontent.com/nutanix-japan/ocp-gitp/main/import_bp/XYZ_OCP_Prov_VM.json) and save as *Initials*_OCP_Prov_VM.json file (e.g XYZ_OCP_Prov_VM.json)

2.  Download blueprint2 by right-clicking on this link [OCP Master Worker](https://raw.githubusercontent.com/nutanix-japan/ocp-gitp/main/import_bp/XYZ_OCP_Master_Worker.json) and save as *Initials*_OCP_Master_Worker.json file (e.g XYZ_OCP_Master_Worker.json)
